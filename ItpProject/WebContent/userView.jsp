                            ...
                            <div class="user-profile d-flex no-block dropdown mt-3">
                                ...
                                <div class="user-content hide-menu ml-2">
                                    <a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <span class="op-5 user-email">harshigmail.com</span>
                                    </a>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add User</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
			...
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                  <form autocomplete="off" method="POST" action="AddUserServlet" style="font-family: Arial, Helvetica, sans-serif; ">                               
 <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">First Name </label>
                        <br />
                        <input id="Fname" name="FName" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Last Name </label>
                        <br />
                        <input id="LName" name="LName" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
				</div>
 <div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <input id="Email" name="Email" type="email" class="form-control" style="color:#F8F8FF; text-transform:uppercase; font-size: 12px" autocomplete="off"  required>
                    </div>
				...
				<div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                         <input id="ContactNumber" name="ContactNumber" type="tel" pattern="^\d{10}$" maxlength="10" class="form-control" style="color:#F8F8FF; font-size:12px; text-transform:uppercase;" autocomplete="off" onkeypress="return onlyNumberKey(event)" required>
                     </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">User Type </label>
                        <br />
                        <input id="UserType" name="UserType" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
					...
					<div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="Username" name="Username" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Password </label>
                        <br />
                        <input id="Password" name="Password" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-6  m-0 p-0">
                        <div class="row m-0 p-0">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <button type="Reset" id="btnReset" class="reset-button btn btn-danger w-100 mt-1" value="Reset">CLEAR</button>
                            </div>
                        </div>
                    </div>
                </div>
