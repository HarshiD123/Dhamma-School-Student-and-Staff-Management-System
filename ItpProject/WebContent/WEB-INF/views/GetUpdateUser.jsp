                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit User</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
...
<form autocomplete="off" method="POST" action="UpdateUserServlet" style="font-family: Arial, Helvetica, sans-serif;">    
	...
	<div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="Fname" name="FName" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getFName()%>"   required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Last Name </label>
                        <br />
                        <input id="LName" name="LName" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getLName()%>"  required>
                    </div>
				</div>
<div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <input id="Email" name="Email" type="email" class="form-control" style="color:#F8F8FF; font-size:12px; text-transform:uppercase;" autocomplete="off" value="<%=user.getEmail()%>"  required>
                    </div>
...
<div class="row m-0 p-0">
				<div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                         <input id="ContactNumber" name="ContactNumber" type="tel" pattern="^\d{10}$" maxlength="10" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" onkeypress="return onlyNumberKey(event)" value="<%=user.getContactNumber()%>" required>
                     </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">User Type </label>
                        <br />
                        <input id="UserType" name="UserType" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getUserType()%>"   required>
                    </div>
			...
			<div class="row m-0 p-0">
					<div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="Username" name="Username" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getUsername()%>"   required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Password </label>
                        <br />
                        <input id="Password" name="Password" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getPassword()%>"   required>
                    </div>
                    ...
                    <div class="col-md-6  m-0 p-0">
                        <div class="row m-0 p-0">
                            ...
                            <input type="hidden" name="UserId" value="<%=user.getUserId()%>" /> 
                                <button type="submit" id="btnSave" class="add-button btn btn-primary w-100 mt-1">SAVE</button>
                            </div>
