...
<%@page import="com.itpm.model.User"%>
<!DOCTYPE html>
...
<body>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    ...
                                    <div class="m-l-10">
                                        <h4 class="m-b-0">Harshani</h4>
                                        <p class=" m-b-0">harshi@gmail.com</p>
                                    </div>
                                </div>
                            ...
                            <div class="user-profile d-flex no-block dropdown mt-3">
                                ...
                                <div class="user-content hide-menu ml-2">
                                    <a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h5 class="mb-0 user-name font-medium">Harshani <i class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email">harshi@gmail.com</span>
                                    </a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">View User</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
	...
	%>
<form autocomplete="off" method="POST" action="UpdateUserServlet" style="font-family: Arial, Helvetica, sans-serif;  ">    
	<div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">User ID </label>
                        <br />
                        <input id="UserId" name="UserId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" disabled="disabled" value="<%=user.getUserId()%>"   required>
                    </div>
                    </div>
	<div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="Fname" name="FName" disabled="disabled"  type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getFName()%>"   required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Last Name </label>
                        <br />
                        <input id="LName" name="LName" disabled="disabled"  type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getLName()%>"  required>
                    </div>
				</div>
<div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        <br />
                        <label class="lablFont">Email </label>
                        <br />
                        <input id="Email" name="Email"  disabled="disabled"  type="email" class="form-control" style="color:#F8F8FF; text-transform:uppercase; font-size: 12px" autocomplete="off" value="<%=user.getEmail()%>"  required>
                    </div>
...
<div class="row m-0 p-0">
				<div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                         <input id="ContactNumber" disabled="disabled"  name="ContactNumber" type="tel" pattern="^\d{10}$" maxlength="10" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" onkeypress="return onlyNumberKey(event)" value="<%=user.getContactNumber()%>" required>
                     </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">User Type </label>
                        <br />
                        <input id="UserType" disabled="disabled"  name="UserType" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getUserType()%>"   required>
                    </div>
			...
			<div class="row m-0 p-0">
					<div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">User Name </label>
                        <br />
                        <input id="Username" name="Username" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getUsername()%>" disabled="disabled"    required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Password </label>
                        <br />
                        <input id="Password" name="Password" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=user.getPassword()%>" disabled="disabled"   required>
                    </div>
...
function myFunction() {
  var sTable = document.getElementById('demo').innerHTML;
        ...
        %>
        win.document.write('<center><h2>Dhamma School - User</h2></center>');
        win.document.write('<br>');
        win.document.write('<h3>User ID: <%=user.getUserId()%></h3>');
        win.document.write('<h3>User Name: <%=user.getFName() + user.getLName() %></h3>');
        ...
        win.document.write('<table><tr><th>Name</th><th>Username</th><th>Email</th><th>Contact number</th><th>User Type</th></tr>'); 
        win.document.write('<tr><td><%=user.getFName() + user.getLName() %></td><td><%=user.getUsername()%></td><td><%=user.getEmail()%></td><td><%=user.getContactNumber()%></td><td><%=user.getUserType()%></td></td></tr>'); 
