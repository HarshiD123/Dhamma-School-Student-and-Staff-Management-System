                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Delete User</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
...
<div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <input id="Email" name="Email"  disabled="disabled"  type="email" class="form-control" style="color:#F8F8FF;font-size:12px; text-transform:uppercase;" autocomplete="off" value="<%=user.getEmail()%>"  required>
                    </div>
                    ...
                    <div class="col-md-6  m-0 p-0">
                        <div class="row m-0 p-0">
                            ...
                            <input type="hidden" name="UserId" value="<%=user.getUserId()%>" /> 
                                <button type="submit" id="btnSave" class="add-button btn btn-danger w-100 mt-1">DELETE</button>
                            </div>
