...
<%@page import="com.itpm.service.UserServiceImpl"%>
<%@page import="com.itpm.service.IUserService"%>
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                            ...
                            <div class="row m-0 p-0">
     						<div class="col-md-6  h-100 w-100">
                   				...
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="userView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
	...
	<table id="example" class="display" >
        <thead>
            <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; ">
                ...
                <th >Email</th>
                <th style="width: 210px;">Mobile</th>
                <th>User Type</th>
                <th style="width: 150px;padding-right: 0px;padding-left: 0px;height: 7px; text-align: center">Select</th>
        ...
        <tbody >
            ...
            %>
            <tr>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=user.getUserId() %> </td>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=user.getUserId() %> <%=user.getFName() %>  </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=user.getEmail()  %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=user.getContactNumber() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=user.getUserType() %> </td>
                 <td> 
		   <table >
             <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetUserServlet">
				<input type="hidden" name="UserId" value="<%=user.getUserId()%>"/>
				 <input type="image" src="assets/images/CRUD/View.png" style="width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="View" alt="Submit">
				</form>
				</th>
				<th>
				<form method="POST" action="GetUpdateUserServlet">
				<input type="hidden" name="UserId" value="<%=user.getUserId()%>"/>
				 <input type="image" src="assets/images/CRUD/edit-8-48.png" style="width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="Edit" alt="Submit">
				</form>
				</th>
				<th>
				<form method="POST" action="GetDeleteUserServlet">
				<input type="hidden" name="UserId" value="<%=user.getUserId()%>"/>
				<input type="image" src="assets/images/CRUD/x-mark-3-48.png" style="width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="Delete" alt="Submit">
				</form>
				</th>
				</tr>
